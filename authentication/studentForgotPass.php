...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $sql = "UPDATE students SET reset_token = '$resetToken', reset_token_expiry = '$expiryTime' WHERE email = '$email'";
        mysqli_query($conn, $sql);
        $resetLink = "localhost/student_attendance_system/authentication/reset_password.php?token=$resetToken";
